...
void SampleDicerAudioProcessor::prepareToPlay(double r,int){hostRate=r;heldNotes=0;burstCountdown=0;glitchWritePosition=0;glitchSamplesRemaining=0;glitchCapturing=false;glitchStutterRepeats=0;for(auto& channel:glitchDelayBuffer)channel.fill(0.0f);for(auto& channel:glitchStutterBuffer)channel.fill(0.0f);}
